...
import com.liubusi.shangrongbao.core.listener.ExcelDictDTOListener;
import com.liubusi.shangrongbao.core.pojo.dto.ExcelDictDTO;
import com.liubusi.shangrongbao.core.pojo.entity.Dict;
import com.liubusi.shangrongbao.core.mapper.DictMapper;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements DictService {
    ...
    public String getNameByParentDictCodeAndValue(String dictCode, Integer value) {
        ...
        dictQueryWrapper.eq("parent_id", parentDict.getParentId()).eq("value", value);
        Dict dict = baseMapper.selectOne(dictQueryWrapper);
